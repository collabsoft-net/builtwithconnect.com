...
import { CustomEvent, EventEmitter,PubSubHandler } from '@collabsoft-net/types';
...
@injectable()
export class ImportAppsTask implements PubSubHandler {

  name = Tasks.ImportAppsTask;
  topic = Tasks.ImportAppsTask
